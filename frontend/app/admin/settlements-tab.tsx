...
// 정산 승인. 대상·금액 계산은 Celery 배치가 미리 만들어둔다고 가정(아직 미구현)하고, 여기서는 승인만 담당.
// GET/POST /admin/settlements 연동.
export default function SettlementsTab() {
  ...
  if (settlements.length === 0) return <p className="text-sm text-foreground/40">정산 대상이 없습니다.</p>;

  return (
    <div className="max-w-3xl overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
